...
该主题在是在小兔仔大佬修改的基础上修改的，[小兔仔博客](https://busybunny.me/)，最终在[我的博客](https://521.ooo)中使用，基于其原主题做了如下修改：
...
- 页面底部添加了访问人数以及访问总量
- 底部添加跳动表情
- 给文章添加了阅读字数统计以及预计阅读时长
- 增加一言、增加了标题特效、增加了输入框特效、增加了点击小红心特效、增加了Next主题跳动心特效等等
- 对Valine添加了表情包并对其进行了简单的修改
